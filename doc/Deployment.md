...
var plugin = require('pip-services-facets-node').FacetsSenecaPlugin;
...
or by using [FacetsSenecaClient](https://github.com/pip-services/pip-clients-facets-node/NodeClientApiV1.md/#client_seneca)