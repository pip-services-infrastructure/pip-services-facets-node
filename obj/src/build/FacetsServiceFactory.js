...
class FacetsServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
FacetsServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-facets", "factory", "default", "default", "1.0");
FacetsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-facets", "persistence", "memory", "*", "1.0");
FacetsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-facets", "persistence", "file", "*", "1.0");
FacetsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-facets", "persistence", "mongodb", "*", "1.0");
FacetsServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-facets", "controller", "default", "*", "1.0");
FacetsServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-facets", "service", "seneca", "*", "1.0");
FacetsServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-facets", "service", "http", "*", "1.0");
